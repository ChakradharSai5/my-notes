During [[14-DeC-2025 OH Reactor test & Unit shutdown for OH]]
...
- Everything was smooth, until we gave setpoint to 3210rpm, speed slowly incrasing, suddenly a big huge single sound came from turbine floor
- My first thought was may be CV got more open than required, so Turbine speed increase so fast so saw the speed and found almost constant at 31xx rpm, so I thought ok, may be line hammering or something, but Sai kiran saw Turbine vibration alarms, and saw turbo visory alarms found, all around 2xx or 3xx, hand tripped, but by that time turbine tripped on high vibrations
