...
- for clarity refer [[Real Time Scheduling]]
#### GNA, TGNA, URS
- This GNA - is kind of medium network access
- TGNA- is short term network access
- URS - if any beneficiary surrenders in T1 block other can avail, for clarity refer [[Real Time Scheduling]]
- So all this gets freezed at D day's T1 block end
#### RTM
- Added in T4 block, from [[Real Time Scheduling]]
#### TRAS
