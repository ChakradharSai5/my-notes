...
- For TDBFP both, R/C closing in curve of F(x), that can be seen
- For MDBFP R/C closing is fixed at 300Tph
- MDBFP auto closing of SOV is at 10sec

- Decouple trial usually takes around 1/3rd of rated current
